...
<body>
    ...
    <?php
        if ($_GET['page'] == 'CV' or $_GET['page'] == 'projects') {
            echo "
                ...
                <br> <br> <br> <br> <br> <br>
                <h1>Error 404</h1>
                <h3>Diese Seite wurde nicht gefunden oder ist noch nicht verfügbar...</h3>
                <br> <br> <br> <br>
            ...
            <section id='middle'>
                ...
                <div class='container'>
                    <p>Ich interessiere mich sehr rundum die IT, insbesondere für die Programmierung von Software.
                        <br>
                        <br>
                        Aktuell suche ich eine Ausbildungsstelle zum Fachinformatiker für Anwendungsentwicklung
                        <br>
                        <br>
                        <br>
                        <br> Unten folgen nun ein paar meiner Fähigkeiten...
                    </p>
                </div>
    ...
    <footer>
        <p title="Programmed by Immanuel"> » Made with ❤️ by Immanuel « </p>
        <br>
        <div>
            <a href="mailto:contact@immanuelm.de">Kontakt</a>
